...
vim.keymap.set('n', 'J', "mzJ`z",
    { desc = "Append the line bellow to the end of current line while keeping cursor position" })
...
-- Quit vim completely and save ZQA
vim.keymap.set("n", "ZAQ", ":wqa <CR>", { desc = "Close vim and save" })
